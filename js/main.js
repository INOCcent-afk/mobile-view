...
// SMOOTH SCROLLING
function init() {
  new SmoothScroll(document, 25, 12);
}
...
projects.forEach((project, index) => {
  project.addEventListener("mouseover", () => {
    if (index === 0) {
      ...
      mouseCursorImage.style.backgroundImage = "url('/images/Umami.jpg')";
      mouseCursorImage.style.display = "block";
    } else if (index === 1) {
      mouseCursorImage.classList.add("mouseCursorHover");
      mouseCursorImage.style.backgroundImage = "url('/images/work-2.jpg')";
      mouseCursorImage.style.display = "block";
    } else if (index === 2) {
      mouseCursorImage.classList.add("mouseCursorHover");
      mouseCursorImage.style.backgroundImage = "url('/images/work-1.jpg')";
      mouseCursorImage.style.display = "block";
    } else if (index === 3) {
      mouseCursorImage.classList.add("mouseCursorHover");
      mouseCursorImage.style.backgroundImage =
        "url('/images/OpenGraph-875x560.jpg')";
      mouseCursorImage.style.display = "block";
    } else if (index === 4) {
      mouseCursorImage.classList.add("mouseCursorHover");
      mouseCursorImage.style.backgroundImage =
        "url('/images/Facebook-Post-EN-1-875x560.png')";
      mouseCursorImage.style.display = "block";
    } else {
      mouseCursorImage.classList.add("mouseCursorHover");
      mouseCursorImage.style.backgroundImage =
        "url('/images/uberem-875x560.jpg')";
      mouseCursorImage.style.display = "block";
    }
  });
});
